...
func updateDNS(c *config.DNS, generalIPv6 bool) {
	...
	r := dns.NewResolver(dns.Config{
		...
		ProxyFallbackIPFilter:      c.ProxyServerFallbackIPFilter,
		DirectServer:               c.DirectNameServer,
		DirectFallback:             c.DirectNameServerFallback,
		DirectFallbackIPFilter:     c.DirectFallbackIPFilter,
		DirectFallbackDomainFilter: c.DirectFallbackDomainFilter,
