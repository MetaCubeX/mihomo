...
var (
	...
	baseURL       string = "https://github.com/wzdnzd/Clash.Meta/releases/download/Prerelease-Alpha/clash.meta"
	versionURL    string = "https://github.com/wzdnzd/Clash.Meta/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
