...
func handleUpgrade(localConn net.Conn, source net.Addr, destination net.Addr, request *http.Request, in chan<- C.ConnContext) (resp *http.Response) {
	...
	in <- inbound.NewHTTP(dstAddr, source, destination, right)
