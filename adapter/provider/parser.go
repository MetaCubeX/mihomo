...
type healthCheckSchema struct {
	...
	StatusCodeRange string `provider:"status-code-range,omitempty"`
}
...
func ParseProxyProvider(name string, mapping map[string]any) (types.ProxyProvider, error) {
	...
	hc := NewHealthCheck([]C.Proxy{}, schema.HealthCheck.URL, hcInterval, schema.HealthCheck.Lazy, schema.HealthCheck.StatusCodeRange)
