...
func TestKeyMethod2ClientMarshalAndDerive(t *testing.T) {
	record := &KeyMethod2Record{
		Options:  InstallScriptOptionsString(ProtoUDP, CipherAES128GCM, AuthSHA256, "", false, nil),
...
func TestKeyMethod2DeriveAES256(t *testing.T) {
	record := &KeyMethod2Record{
		Options:  InstallScriptOptionsString(ProtoUDP, CipherAES256GCM, AuthSHA256, "", false, nil),
...
func TestInstallScriptOptionsCBCSHA1(t *testing.T) {
	options := InstallScriptOptionsString(ProtoTCP, CipherAES256CBC, AuthSHA1, "", false, nil)
...
func TestInstallScriptOptionsTLSAuth(t *testing.T) {
	keyDirection := 1
	options := InstallScriptOptionsString(ProtoUDP, CipherAES256CBC, AuthSHA256, "", true, &keyDirection)
