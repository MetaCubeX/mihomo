...
func normalizeTLSMinVersion(version string) string {
...
func (c *ClientConfig) Prepare() error {
	...
	c.TLSMinVersion = normalizeTLSMinVersion(c.TLSMinVersion)
...
func (c *ClientConfig) ValidateInstallScriptSubset() error {
	...
	if c.TLSMinVersion != TLSVersion10 && c.TLSMinVersion != TLSVersion11 && c.TLSMinVersion != TLSVersion12 && c.TLSMinVersion != TLSVersion13 {
		return fmt.Errorf("unsupported openvpn tls-version-min %q: only %s, %s, %s and %s are supported", c.TLSMinVersion, TLSVersion10, TLSVersion11, TLSVersion12, TLSVersion13)
	}
