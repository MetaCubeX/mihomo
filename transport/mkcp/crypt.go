...
// SimpleAuthenticator is the default (no-seed) mKCP authenticator. It is a
// legacy AEAD used for KCP packet integrity, ported verbatim from xray-core so
// that the wire format stays byte-compatible.
